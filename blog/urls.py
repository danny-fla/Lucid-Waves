...
from .views import AddPostView, EditPostView, AddCommentView, DeletePostView, AddImageView, EditImageView, DeleteImageView
...
urlpatterns = [
    ...
    path('gallery/<int:pk>/delete', DeleteImageView.as_view(), name='delete_image'),
